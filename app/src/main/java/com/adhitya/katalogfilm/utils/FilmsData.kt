...
object FilmsData {
    ...
    fun generateRemoteMoviesData(): List<MoviesResultsItem> {
        val listMovies = ArrayList<MoviesResultsItem>()
        val listGenres = listOf(28, 878, 53)
        listMovies.add(
            MoviesResultsItem(
                "457136".toInt(),
                "Mary Queen of Scots",
    ...
    fun generateRemoteTvShowsData(): List<ResultsItem> {
        val listTvShows = ArrayList<ResultsItem>()
        val listGenres = listOf(28, 878, 53)
        val listLanguage = listOf("English", "Indonesian")
    ...
    fun generateRemoteTvShowsDetailsData() : TVShowsDetailsResponse {
        val listGenresItems = listOf(
            GenresItem("Normal", 1),
            GenresItem("Null", 2)
        )
